...
def main():
    ...
    trainer.run_data(G=G, lambda_range=(0.01, 0.2))
    ...
    with plt.style.context(['science', 'nature']):
        ...
        ax = plt.subplot()
        ax.plot(df_out.index.values, df_out.values, color='blue', label='TGNN', ls='-.')
        ax.plot(df_mean.index.values, df_mean.values, color='red', label='Mean', ls='-')
