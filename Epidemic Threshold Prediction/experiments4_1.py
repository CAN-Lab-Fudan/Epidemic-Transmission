...
def main():
    ...
    edge_list = np.loadtxt(os.path.join(real_natworks_path, 'facebook_combined.txt'), dtype=int)
    ...
    with plt.style.context(['science', 'ieee']):
        figure = plt.figure()
        plt.title(r'The results on Facebook network')
        ax = plt.subplot()
